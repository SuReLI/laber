...
from dopamine.agents.dqn_PER import dqn_PER_agent # Add by myself
from dopamine.agents.dqn_LABER import dqn_LABER_agent # Add by myself
from dopamine.agents.dqn_GER import dqn_GER_agent # Add by myself
from dopamine.agents.rainbow_LABER import rainbow_LABER_agent # Add by myself
from dopamine.agents.rainbow_GER import rainbow_GER_agent # Add by myself
...
def create_agent(sess, environment, agent_name=None, summary_writer=None,
  ...
  if agent_name == 'dqn':
    ...
    return rainbow_agent.RainbowAgent(
        ...
        summary_writer=summary_writer)
  elif agent_name == 'dqn_per':
    return dqn_PER_agent.DQN_PER_Agent(
        sess, num_actions=environment.action_space.n,
        summary_writer=summary_writer)
  elif agent_name == 'dqn_laber':
    return dqn_LABER_agent.DQN_LABER_Agent(
        sess, num_actions=environment.action_space.n,
        summary_writer=summary_writer)
  elif agent_name == 'dqn_ger':
    return dqn_GER_agent.DQN_GER_Agent(
        sess, num_actions=environment.action_space.n,
        summary_writer=summary_writer)
  elif agent_name == 'rainbow_laber':
    return rainbow_LABER_agent.rainbow_LABER_Agent(
        sess, num_actions=environment.action_space.n,
        summary_writer=summary_writer)
  elif agent_name == 'rainbow_ger':
    return rainbow_GER_agent.Rainbow_GER_Agent(
	sess, num_actions=environment.action_space.n,
	summary_writer=summary_writer)
