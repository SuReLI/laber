...
#            avg_return_array.append(numpy.around(avg_return, 2))
        
#        if e % 100000 == 0:
#            inter_name = 'results/dqn_' + n + '_saveinter_' + str(e)
#            pickle.dump(avg_return_array, open(inter_name, 'wb'))
...
#    name_final = 'results/dqn_' + n + '_data_return'
#    pickle.dump(data_return, open(name_final, 'wb'))
