...
class TD3_PER(OffPolicyAlgorithm):
    """
    ...
    def _setup_model(self) -> None:
        super(TD3_PER, self)._setup_model()
    ...
    def learn(
        ...
        tb_log_name: str = "TD3_PER",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> OffPolicyAlgorithm:

        return super(TD3_PER, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(TD3_PER, self)._excluded_save_params() + ["actor", "critic", "actor_target", "critic_target"]
