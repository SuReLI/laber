...
class GER_TD3(object):
    ...
    def train(self, replay_buffer, batch_size=100):
        ...
        # Get current Q estimates and per-sample gradient norms
        ...
        critic2_loss = (weights2 * F.mse_loss(current_Q2, Q_target_next2, reduction='none')).mean() # * weights1
